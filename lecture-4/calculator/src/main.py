...
class ScientificButton(CalcButton):
    def __init__(self, text, button_clicked):
        CalcButton.__init__(self, text, button_clicked)
        self.bgcolor = ft.Colors.DEEP_PURPLE_200
        self.color = ft.Colors.BLACK
    ...
    def button_clicked(self, e):
        ...
        # Scientific functions
            ...
            try:
                ...
                self.result.value = str(self.format_number(math.sin(radians)))
                self.reset()
            except:
                self.result.value = "Error"
            ...
            try:
                ...
                # Convert to radians (assuming input is in degrees)
                radians = math.radians(value)
                self.result.value = str(self.format_number(math.cos(radians)))
                self.reset()
            except:
                self.result.value = "Error"
            ...
            try:
                ...
                # Convert to radians (assuming input is in degrees)
                radians = math.radians(value)
                self.result.value = str(self.format_number(math.tan(radians)))
                self.reset()
            except:
                self.result.value = "Error"
            ...
            try:
                ...
                if value < 0 or value != int(value):
                    ...
                    self.result.value = str(self.format_number(math.factorial(int(value))))
                self.reset()
            except:
                self.result.value = "Error"
